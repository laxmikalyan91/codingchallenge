package com.walmart.ticketservice.services.impl;
...
public class TicketServiceImpl implements TicketService {
    ...
    //TODO
    @Override
    public String reservedSeats(int holdId, String customerEmail) {
        ...
        {
           seatReserved = seats.getRowNum()+""+seats.getColumnNum();
